...
export const options = {
  ...
  mods: {
    speed: [
      0.25, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2, 2.25, 2.5, 2.75, 3, 3.25, 3.5, 3.75, 4, 4.5, 5, 5.5, 6, 6.5, 7, 7.5, 8,
    ],
    ...
    freezes: ['on', 'off'],
    jumps: ['on', 'off'],
    noteColor: ['rainbow', 'note', 'vivid', 'flat'],
    // noteShape: ['normal', 'classic', 'cyber', 'x'],
